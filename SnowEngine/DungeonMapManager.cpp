...
{	
	...
	cdDOWN->SetName(L"WallUpCollider");
	...
	cdLEFT->SetName(L"WallLeftCollider");
	...
	cdRIGHT->SetName(L"WallRightCollider");
...
void DungeonMapManager::MonsterSpawn(int _num, int i, int j)
{
	...
	case 128:
	{
		...
		else if (SceneManager::GetActiveScene()->GetName() == L"DungeonScene03") {
			return;
		}
